    ...
    <div class="flex flex-col p-0 pb-6 m-h-screen">
        <div class="flex flex-col gap-1 lg:p-0 p-0  rounde-lg m-0">
            <div class=" flex flex-row justify-between items-center lg:text-2xl md:text-xl text-lg lg:pb-3 p-0 font-black text-gray-700">
                <h2>
                    Secciones del curso:
                </h2>@hasanyrole('Instructor|Admin') <a href="{{route('courses.paso2', $course)}}" class=" mr-4"><i class="fa-solid fa-pen text-blue-900"></i></a>@endhasanyrole
            ...
            <div class=" bg-gray-200 bg-opacity-100  rounded-xl p-2  mb-8">
                ...
                <x-course.list-lesson-new-view :lesson="$lesson"  :resources="$resources" :sections="$numSection" :courseid="$sections->course_id" :section_id="$sections->id" 
