            ...
            <li>
                ...
                <div class="ml-8 mt-2">
                    <div x-data="{ open: false }">
                        <button @click="open = !open" class=" w-full bg-blue-500 bg-opacity-50 text-blue-700 text-sm px-4 py-2 rounded-md">
                            Agregar Recurso
                        </button>
                        <div x-show="open" class="mt-2">
                            <form id="resource-form-{{$lessons->id}}" class="space-y-4" enctype="multipart/form-data">
                                <input type="text" name="name" placeholder="Nombre del recurso" class="w-full p-2 border rounded">
                                ...
                                <input type="url" name="url" placeholder="URL del recurso" class="url-input w-full p-2 border rounded hidden">
                                <input type="hidden" name="lesson_id" value="{{$lessons->id}}">
                                <button type="button" data-form="resource-form-{{$lessons->id}}" class="submit-resource bg-green-500 text-white px-4 py-2 rounded-md">
                                    Guardar Recurso
                                </button>
                            </form>
                        </div>
