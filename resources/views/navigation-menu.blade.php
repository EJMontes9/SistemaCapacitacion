            ...
            <div class="flex-1 px-3 bg-white divide-y space-y-1">
                ...
                <div class="space-y-2 pt-2">
                    ...
                    <form method="POST" action="{{ route('logout') }}" x-data>
                        @csrf
                        <a class="text-base bg-red-500 text-white font-normal rounded-lg hover:bg-white hover:text-red-500 flex items-center p-2 group"
                            href="{{ route('logout') }}" @click.prevent="$root.submit();">
                            <svg class="w-6 h-6 text-white group-hover:text-red-500 transition duration-75"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm10.293 9.293a1 1 0 001.414 1.414l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            <span class="ml-3 flex-1 whitespace-nowrap text-white group-hover:text-red-500">Cerrar Sesión</span>
                        </a>
                    </form>
