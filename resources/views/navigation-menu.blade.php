        ...
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 bg-white divide-y space-y-1">
                <ul class="space-y-2 pb-2">
                    ...
                    <!-- Solo con permisos de Crear cursos puede ver esta seccion -->
                    @can('Crear cursos')
                        <li>
                            <a href="{{ route('courses.create') }}"
                                class="text-base font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ Route::is('courses.create') ? '!text-blue-500 bg-blue-100' : 'text-gray-900' }}">
                    ...
                    <li>
                        <a href="/courses"
                            class="text-base font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ url()->current() == url('/courses') ? '!text-blue-500 bg-blue-100' : 'text-gray-900' }}">
                            <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z"
