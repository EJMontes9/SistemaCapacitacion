                ...
                <form action="{{ route('admin.assignments.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="course_id" class="form-control @error('course_id') is-invalid @enderror" required>
                            ...
                            <option value="{{ $course->id }}" {{ old('course_id', $selectedCourseId ?? null) == $course->id ? 'selected' : '' }}>{{ $course->title }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="max_score" class="form-control @error('max_score') is-invalid @enderror" value="{{ old('max_score', 10) }}" min="1" max="10" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox mt-4">
                                    <input type="checkbox" name="allow_late" id="allow_late" class="custom-control-input" value="1" {{ old('allow_late') ? 'checked' : '' }}>
